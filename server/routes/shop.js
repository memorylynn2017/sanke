...
router.post('/editShop', function(req, res, next) {
    const params = req.body;
    Shop.update({ shop_id: params.shop_id }, { shop_type: params.shop_type, shop_level: params.shop_level, shop_name: params.shop_name, shop_short: params.shop_short, shop_accout: params.shop_accout, shop_credit: params.shop_credit, shop_cr_human: params.shop_cr_human, shop_cr_telephone: params.shop_cr_telephone, shop_alert: params.shop_alert, shop_cr_weixi: params.shop_cr_weixi, shop_cr_address: params.shop_cr_address, shop_cr_alert: params.shop_cr_alert, shop_Stall: params.shop_Stall, shop_market: params.shop_market, shop_floor: params.shop_floor, shop_contact: params.shop_contact, shop_scope: params.shop_scope, shop_area: params.shop_area, shop_ranking: params.shop_ranking, shop_password: params.shop_password, shop_confirm: params.shop_confirm, shop_auth: params.shop_auth, shop_status: params.shop_status }, function(err) {
        if (err) {
            res.json({
                status: 100,
                msg: '修改商家信息失败'
