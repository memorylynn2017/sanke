<template>
    <div class="fillcontain">
        ...
        <div class="headAdv">
            ...
            <div class="searched">
                <div class="btn" style="position:relative;left:-155px;display:inline-block;">
                    <el-button @click="handleAdd">订单入口</el-button>
                </div>
        ...
        filterUser() {
            if (this.purvalue0 == "" || this.purvalue0 == "所有渠道") {
                ...
                if (this.purvalue1 == "" || this.purvalue1 == "全部") {
                    ...
                    this.orderList = this.tableData.filter(item => {
                        return (
                            item.order_fetch == this.purvalue0 && item.order_purstatus == this.purvalue1
                        );
                    });
                }
            }
