                ...
                <el-table-column type="expand">
                    <!-- <template slot-scope="props">
                          <el-form label-position="left" inline class="demo-table-expand">
                              <el-form-item label="分类名称" :label-width="formLabelWidth"> <span></span> </el-form-item>
                              <el-form-item label="排序" :label-width="formLabelWidth"> <span></span> </el-form-item>
                              <el-form-item label="操作" :label-width="formLabelWidth"> <span></span> </el-form-item>
                          </el-form>
                        </template> -->
                </el-table-column>
                <el-table-column prop="id" label="分类名称"> </el-table-column>
                <el-table-column prop="name" label="排序" width="80"></el-table-column>
                <el-table-column prop="shop" label="操作" width="600" class="control"></el-table-column>
            </el-table>
