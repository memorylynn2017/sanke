            ...
            <el-tabs type="border-card">
                            ...
                            <tr>
                                ...
                                <td>
                                    <el-select size="small" v-model="goodForm.product_class" placeholder="请选择">
                                        <el-option v-for="item in levels1" :key="item.value" :label="item.label" :value="item.value">
                                        </el-option>
                                    </el-select>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <el-select size="small" v-model="goodForm.product_area" placeholder="请选择">
                                        <el-option v-for="item in levels2" :key="item.value" :label="item.label" :value="item.value">
                                        </el-option>
                                    </el-select>
                                </td>
                            </tr>
                ...
                <el-tab-pane class="shopset" label="商品规格">
                    <table class="table0 w100">
                        ...
                        <tr>
                            <td>设置库存
                                <div style="font-size: 12px;text-align: justify; color: #e51c23;">(温馨提示：无货空挂可能会引起买家或卖家的投诉。)</div>
                            </td>
                            <td>
